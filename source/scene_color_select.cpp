...
static u32 colors[] = {
    ...
    C2D_Color32(0xff, 0x00, 0x00, 0x50),
    C2D_Color32(0x00, 0xff, 0x00, 0x50),
    C2D_Color32(0x00, 0x00, 0xff, 0x50),
    C2D_Color32(0xff, 0xff, 0x00, 0x50),
    C2D_Color32(0xff, 0x00, 0xff, 0x50),
    C2D_Color32(0x00, 0xff, 0xff, 0x50),
};
static u32 per_row;
